...
def parse(params_list,windows_memory):
    zcashtographson_rest.zcash_to_graphson(params_list,windows_memory)
...
if __name__ == "__main__":
    ...
    while True:
        ...
        #if block_height >= block_num + windows_memory and block_height <= block_num + 3 * windows_memory:
            if block_num + windows_memory >= 100000:
                windows_memory = 100000 % windows_memory

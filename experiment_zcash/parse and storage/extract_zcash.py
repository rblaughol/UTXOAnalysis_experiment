...
# directory
property_dir = "/home/slave15/experiment/storage/"
# parameters
...
def init(property_dir):
    ...
    local_file_path = '/home/slave15/experiment/storage/zcash_loader.properties'
    remote_file_path = '/public/home/blockchain/master/experiment/storage/'
...
def zcash_rpc(rpc_url, rpc_user, rpc_password, method, params_list):
    ...
    while True:        
        try:
            ...
            block_height = result[0]['result']['height']
            return result
        except:
            continue
...
if __name__ == "__main__":
    ...
    while True:
        ...
        if block_time >= start_time or block_num >= 100000 - windows_memory:
            print(processes)
            for process in processes:
                if process.is_alive():
                    process.join()
            ...
            scp.close()
            #end_time = time.time()
            #print("program period: " + str(end_time - start_time))
            break

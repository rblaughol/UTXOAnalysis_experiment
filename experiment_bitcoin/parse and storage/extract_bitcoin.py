...
# directory
property_dir = "/public/home/blockchain/master/experiment_bitcoin/storage/"
# parameters
...
def init(property_dir):
    ...
    shutil.rmtree("/public/home/blockchain/master/experiment_bitcoin/storage/bitcoin_graphson")
    os.mkdir("/public/home/blockchain/master/experiment_bitcoin/storage/bitcoin_graphson")
    ...
    try:
        ...
        pass
    subprocess.run("rm -r /public/home/blockchain/master/experiment_bitcoin/storage/data_tmp", shell=True, capture_output=True)
    if os.path.exists("/public/home/blockchain/master/experiment_bitcoin/storage/data_tmp") and os.path.isdir("/public/home/blockchain/master/experiment_bitcoin/storage/data_tmp"):
    ...
    #err=result.stderr.decode("utf-8")
    #print(out,err)
    subprocess.run("mkdir /public/home/blockchain/master/experiment_bitcoin/storage/data_tmp", shell=True, capture_output=True)
    #out=result.stdout.decode("utf-8")
    #err=result.stderr.decode("utf-8")
    #print(out,err)
    result = subprocess.run("touch /public/home/blockchain/master/experiment_bitcoin/storage/data_tmp/bitcoin.conf", shell=True, capture_output=True)
    #out=result.stdout.decode("utf-8")
    #err=result.stderr.decode("utf-8")
    #print(out,err)
    property_file = "/public/home/blockchain/master/experiment_bitcoin/storage/data_tmp/bitcoin.conf"
    content = file_property.parse(property_file)
    ...
    #while True:
    result = subprocess.run("nohup /public/home/blockchain/master/bitcoin-0.21.1/bin/bitcoind -datadir=/public/home/blockchain/master/experiment_bitcoin/storage/data_tmp &", shell=True)
...
def restart_client_stopS():
    ...
    while True:
        ...
        if "Shutdown: done" in line:
            break
    result = subprocess.run("nohup /public/home/blockchain/master/bitcoin-0.21.1/bin/bitcoind -datadir=/public/home/blockchain/master/experiment_bitcoin/storage/data_tmp -noconnect &", shell=True)
    while True:
        # print("11111")
        result = subprocess.run("/public/home/blockchain/master/bitcoin-0.21.1/bin/bitcoin-cli -getinfo", shell=True, capture_output=True)
        out=result.stdout.decode("utf-8")
...
if __name__ == "__main__":
    ...
    while True:
        ...
        if block_time >= start_time or block_num >= 50000 - windows_memory:
            restart_client_stopS()
            for process in processes:
                if process.is_alive():
                    process.join()

...
graphson_dir = "/public/home/blockchain/master/experiment_bitcoin/storage/bitcoin_graphson/"
...
def bitcoin_to_graphson(params_list,windows_memory):
    ...
    if file_num >= 1:
        ...
        while True:
            try:
                ...
                hashlib2 = calculate_file_hash("/public/home/blockchain/master/experiment_bitcoin/storage/tmp/" + form_json_file)
    ...
    with open(graphson_dir + current_json_file,'w') as fd:
        with open("/public/home/blockchain/master/experiment_bitcoin/storage/tmp/" + current_json_file,'w') as fm:
            fm.write(tx_string)
            fm.close()
            while True:
                try:
                    property_file = "/public/home/blockchain/master/experiment_bitcoin/storage/bitcoin_loader.properties"
                    content = file_property.parse(property_file)
